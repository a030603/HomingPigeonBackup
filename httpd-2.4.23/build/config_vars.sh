...
if test -f ${DESTDIR}/home/cs408_team3/apache/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/cs408_team3/apache/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/cs408_team3/apache/bin/apu-1-config
else
...
test -n "/home/cs408_team3/apache/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/cs408_team3/apache/build"
