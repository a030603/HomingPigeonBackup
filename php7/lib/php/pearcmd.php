...
if ('/home/cs408_team3/php-7.0.12/php7/lib/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/home/cs408_team3/php-7.0.12/php7/lib/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
